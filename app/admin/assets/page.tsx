...
export default function AdminAssetsInventory() {
  ...
  const [laptopAllocations, setLaptopAllocations] = useState<
    LaptopAllocation[]
  >(mockLaptopAllocations);
  const [mobileAllocations, setMobileAllocations] = useState<
    MobileAllocation[]
  >(mockMobileAllocations);
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div
                className={`p-3 rounded-full ${activeTab === "laptop" ? "bg-blue-50" : "bg-gray-50"}`}
              >
                <svg
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div
                className={`p-3 rounded-full ${activeTab === "mobile" ? "bg-blue-50" : "bg-gray-50"}`}
              >
                <svg
                  className="w-6 h-6 text-blue-600"
                  fill="none"
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div
                className={`p-3 rounded-full ${activeTab === "monitor" ? "bg-blue-50" : "bg-gray-50"}`}
              >
                <svg
                  className="w-6 h-6 text-blue-600"
                  fill="none"
